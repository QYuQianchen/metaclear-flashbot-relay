...
replace github.com/attestantio/go-eth2-client => github.com/QYuQianchen/metaclear-go-eth2-client v0.0.1

require (
	github.com/NYTimes/gziphandler v1.1.1
	github.com/alicebob/miniredis/v2 v2.33.0
	github.com/attestantio/go-builder-client v0.4.6
	...
	github.com/flashbots/mev-boost-relay v0.29.1
